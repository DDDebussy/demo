 ...
 */
public class FocusCuisineFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_focus_cuisine, null);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.recyclerview_focus_cuisine);
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.swiperefreshlayout_focus_cuisine);
        mFloatingActionButton = (FloatingActionButton) view.findViewById(R.id.fab_focus_cuisine);
